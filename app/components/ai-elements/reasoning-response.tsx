...
export type ReasoningResponseProps = HTMLAttributes<HTMLDivElement> & {
  options?: Options;
...
const components: Options['components'] = {
  ...
  li: ({ node, children, className, ...props }) => (
    <li className={cn('ml-4 my-1 text-sm text-muted-foreground', className)} {...props}>
      {children}
    </li>
  ),
  ...
  h1: ({ node, children, className, ...props }) => (
    <h1
      className={cn('my-1 font-semibold text-3xl', className)}
      {...props}
    >
      {children}
    </h1>
  ...
  h2: ({ node, children, className, ...props }) => (
    <h2
      className={cn('my-1 font-semibold text-2xl', className)}
      {...props}
    >
      {children}
    </h2>
  ...
  h3: ({ node, children, className, ...props }) => (
    <h3 className={cn('my-1 font-semibold text-xl', className)} {...props}>
      {children}
    </h3>
  ),
  h4: ({ node, children, className, ...props }) => (
    <h4 className={cn('my-1 font-semibold text-lg', className)} {...props}>
      {children}
    </h4>
  ),
  h5: ({ node, children, className, ...props }) => (
    <h5
      className={cn('my-1 font-semibold text-base', className)}
      {...props}
    >
      {children}
    </h5>
  ...
  h6: ({ node, children, className, ...props }) => (
    <h6 className={cn('my-1 font-semibold text-sm', className)} {...props}>
      {children}
    </h6>
  ),
  p: ({ node, children, className, ...props }) => (
    <p className={cn('my-1 text-sm text-muted-foreground', className)} {...props}>
      {children}
    </p>
  ),
  ...
  pre: ({ node, className, children }) => {
    ...
    return (
      <CodeBlock
        className={cn('my-4 h-auto bg-neutral-50', className)}
        code={code}
        language={language}
      >
        <CodeBlockCopyButton
...
export const ReasoningResponse = memo(
  ({
    className,
    options,
    children,

...
const components: Options["components"] = {
  ...
  h1: ({ node, children, className, ...props }) => (
    <h1 className={cn("my-6 font-semibold text-3xl", className)} {...props}>
      {children}
    </h1>
  ),
  h2: ({ node, children, className, ...props }) => (
    <h2 className={cn("my-6 font-semibold text-2xl", className)} {...props}>
      {children}
    </h2>
  ),
  ...
  h5: ({ node, children, className, ...props }) => (
    <h5 className={cn("my-6 font-semibold text-base", className)} {...props}>
      {children}
    </h5>
  ),
  ...
  table: ({ node, children, className, ...props }) => (
    <div className="my-4 rounded-lg border w-full">
      <ScrollArea>
        <table
          className={cn(
            "w-full border-collapse border-border rounded-t-lg",
            className
          )}
          {...props}
        >
  ...
  tr: ({ node, children, className, ...props }) => (
    <tr
      className={cn("border-b hover:bg-muted/30 border-border", className)}
      {...props}
    >
      {children}
    </tr>
  ...
  th: ({ node, children, className, ...props }) => (
    <th
      className={cn(
        "px-4 py-2 text-left font-semibold text-sm truncate rounded-tl-lg",
        className
      )}
      {...props}
    >
  ...
  td: ({ node, children, className, ...props }) => {
    return (
      <td
        className={cn(
          "px-4 py-2 text-sm rounded-tr-lg whitespace-pre-wrap",
          className
        )}
        {...props}
      >

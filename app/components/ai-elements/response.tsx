...
const components: Options['components'] = {
  ...
  li: ({ node, children, className, ...props }) => (
    <li className={cn('ml-4 my-2 text-base', className)} {...props}>
      {children}
    </li>
  ),
  ul: ({ node, children, className, ...props }) => (
    <ul className={cn('ml-3 list-outside list-disc', className)} {...props}>
      {children}
    </ul>
  ),
  ...
  h1: ({ node, children, className, ...props }) => (
    <h1
      className={cn('my-6 font-semibold text-3xl', className)}
      {...props}
    >
      {children}
    </h1>
  ...
  h2: ({ node, children, className, ...props }) => (
    <h2
      className={cn('my-6 font-semibold text-2xl', className)}
      {...props}
    >
      {children}
    </h2>
  ...
  h3: ({ node, children, className, ...props }) => (
    <h3 className={cn('my-6 font-semibold text-xl', className)} {...props}>
      {children}
    </h3>
  ),
  h4: ({ node, children, className, ...props }) => (
    <h4 className={cn('my-6 font-semibold text-lg', className)} {...props}>
      {children}
    </h4>
  ),
  h5: ({ node, children, className, ...props }) => (
    <h5
      className={cn('my-6 font-semibold text-base', className)}
      {...props}
    >
      {children}
    </h5>
  ...
  h6: ({ node, children, className, ...props }) => (
    <h6 className={cn('my-6 font-semibold text-sm', className)} {...props}>
      {children}
    </h6>
  ),
  p: ({ node, children, className, ...props }) => (
    <p className={cn('my-6 text-base', className)} {...props}>
      {children}
    </p>
  ),
  ...
  (
    <div className="my-4 rounded-lg border w-full">
      <ScrollArea>
        <table
          className={cn('w-full border-collapse border-border rounded-t-lg', className)}
          {...props}
        >
          {children}
        </table>
      ...
      <div className="w-full p-1 bg-muted/20 flex items-center justify-end rounded-b-lg">
        <Tooltip>
  ...
  thead: ({ node, children, className, ...props }) => (
    <thead className={cn('bg-muted/50 rounded-t-lg', className)} {...props}>
      {children}
    </thead>
  ),
  ...
  tr: ({ node, children, className, ...props }) => (
    <tr className={cn('border-b hover:bg-muted/30 border-border', className)} {...props}>
      {children}
    </tr>
  ),
  th: ({ node, children, className, ...props }) => (
    <th
      className={cn('px-4 py-2 text-left font-semibold text-sm truncate rounded-tl-lg', className)}
      {...props}
    >
      {children}
    </th>
  ...
  td: ({ node, children, className, ...props }) => {
    return (
      <td className={cn('px-4 py-2 text-sm rounded-tr-lg whitespace-pre-wrap', className)} {...props}>
        {children}
      </td>
    );
  },
  blockquote: ({ node, children, className, ...props }) => (
    <blockquote
      className={cn(
        'my-4 border-l-4 border-muted-foreground/30 pl-4 italic bg-muted/50 py-0.5 rounded-r-xl',
        className,
      )}
      {...props}
    >
